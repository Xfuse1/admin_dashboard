...
class StoreOnboardingModel extends StoreOnboardingEntity {
  ...
  factory StoreOnboardingModel.fromJson(Map<String, dynamic> json) {
    return StoreOnboardingModel(
      ...
      taxCardImageUrl: json['taxCardImageUrl'] as String?,
      phoneVerified: json['phoneVerified'] as bool? ?? false,
      phoneVerifiedAt: json['phoneVerifiedAt'] != null
          ? (json['phoneVerifiedAt'] is DateTime
              ? json['phoneVerifiedAt']
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'taxCardImageUrl': taxCardImageUrl,
